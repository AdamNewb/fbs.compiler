...
#'
#' This function compiles seed rates from official data and imputes them where missing using
#' default rates . E.g. where seed rates are missing for rye, it will apply
...
# replace "China, mainland (41)" with missing "China (351)" as China, mainland 
# will dominate seed rates for all of China
